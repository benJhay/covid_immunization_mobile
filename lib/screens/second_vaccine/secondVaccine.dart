...
import 'package:covid_immunization_mobile/screens/emptyPage.dart';

import 'package:covid_immunization_mobile/screens/second_vaccine/widget/widget.dart';
...
class SecondVaccinationPage extends StatefulWidget {
  @override
  _SecondVaccinationPageState createState() => _SecondVaccinationPageState();
}

class _SecondVaccinationPageState extends State<SecondVaccinationPage> {
  GlobalKey<FormState> _key = GlobalKey<FormState>();
  final TextEditingController nameOfVaccineController = TextEditingController();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          appBar(context: context, title: "First Vaccination", elevation: 0.0),
      body: SafeArea(
        child: Container(
